...
class ArticleFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $article1 ->setPicture('cover-r4x3w1000-6218f4a89b159-049-f0219630.jpg');
        ...
        $article2 ->setPicture('03cb1e02f9_97024_chiffre-nombre-numero.jpg');
        ...
        $article3 ->setTitle('Une cyberattaque contre l\'Otan pourrait déclencher la clause de défense collective');
        ...
        $article3 ->setPicture('cover-r4x3w1000-621d456eced9d-une-cyberattaque.jpg');
        ...
        $article4 ->setPicture('cover-r4x3w1000-6130a5081a3e9-arnolfini3d.jpg');
